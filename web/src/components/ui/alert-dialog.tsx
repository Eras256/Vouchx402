    ...
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Viewport className="fixed inset-0 z-50 flex items-center justify-center p-4">
        <AlertDialogPrimitive.Popup
          ...
          className={cn(
            "w-full max-w-sm rounded-xl border border-border bg-card p-5 shadow-lg outline-none duration-150 data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95 sm:p-6",
            className
          )}
          {...props}
        >
